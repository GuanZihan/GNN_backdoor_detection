...
def add_model_group(group):
    group.add_argument('--model', type=str, default='gcn', help="used models")
    group.add_argument('--train_ratio', type=float, default=0.5, help="ratio of trainset from whole dataset")
    group.add_argument('--hidden_dim', nargs='+', default=[64,64,64,64,64], type=int,
    ...
    group.add_argument('--clean_model_save_path', type=str, default='../save/models/clean')
...
def add_atk_group(group):
    ...
    group.add_argument('--bkd_size', type=int, default=6, help="number of nodes for each trigger")
    ...
    group.add_argument('--gtn_epochs', type=int, default=1, help="# attack epochs")
    ...
    group.add_argument('--bkd_model_save_path', type=str, default='../save/models/bkd')
    group.add_argument('--device', type=str, default='0')
