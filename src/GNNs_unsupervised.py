...
class GNN(object):
    ...
    """
    def __init__(self, adj_matrix, features=None, labels=None, supervised=False, model='gat', n_layer=5, emb_size=8, random_state=1234, device='auto', epochs=20, batch_size=5, lr=0.7, unsup_loss_type='margin', print_progress=True):
